...
const projects = [
  ...
  {name: 'CodeCraft', descripton: 'Online IDE with multi-language support',stack: ['React JS', 'Express JS', 'Node JS','Typescript','Passport JS', 'Zustand', 'Socket IO','Postgresql','Prisma', 'Tailwind CSS', 'ShadCN UI', 'Tanstack Query'], liveUrl: '', github: 'https://github.com/Virajb19/CodeCraft'},
  {name: 'ChatPDF', descripton: 'Upload PDFs and chat with an AI assistant to extract key insights.',stack: ['Next JS', 'Typescript','Next Auth', 'Postgresql','Prisma', 'Tailwind CSS', 'ShadCN UI', 'Tanstack Query', 'Stripe', 'Zod', 'AppWrite', 'Pinecone DB'], liveUrl: '', github: 'https://github.com/Virajb19/ChatPDF'},
  {name: 'Learning Journey', descripton: 'Create courses using AI',stack: ['Next JS', 'Typescript','Next Auth', 'Postgresql','Prisma', 'Tailwind CSS', 'ShadCN UI', 'tRPC', 'Zod', 'Stripe'], liveUrl: '', github: 'https://github.com/Virajb19/Learning-Journey'},
  {name: 'Quick Chat', descripton: 'A chat app built using Socket IO',stack: ['Next JS', 'Typescript','Next Auth', 'Postgresql','Prisma', 'Tailwind CSS', 'ShadCN UI', 'tRPC', 'Zod', 'Socket IO'], liveUrl: '', github: 'https://github.com/Virajb19/QuickChat'}
]
