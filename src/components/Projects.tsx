...
const projects = [
  {name: 'GitAsk', descripton: 'Ask AI about your Github repository',stack : ['Next JS', 'Typescript','Next Auth', 'Postgresql','Prisma', 'Tailwind CSS', 'ShadCN UI', 'Zod', 'Tanstack Query', 'Stripe', 'Appwrite'], liveUrl: 'https://gitask.vercel.app', github: 'https://github.com/Virajb19/GitAsk'},
