...
export default function EmailCard() {
  ...
  return <motion.div initial={{opacity: 0, y: -25}} whileInView={{opacity: 1, y: 0}} transition={{duration: 1, ease: 'easeInOut'}} className="border-[3px] border-orange-800 mb:w-[90vw] flex flex-col items-center gap-3 p-5 rounded-lg text-2xl text-white">
    <p>
